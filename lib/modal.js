...
function exampleModal() {
    var header_text = '<h1>Redirecting...</h1>';
    ...
    var image_path = '../../docs/data/assets/drawings/walking_tablet.jpg';
    var icon_path = '../../docs/data/assets/sparkle_multi.svg';
    splitModal(header_text, paragraph_text, image_path, '');
}

function aboutModal() {
    //var header_text = `<p class="title is-3">${appName}</p>`
    var header_text = `<img id="logo" class="pl-0 ml-0" src="../../docs/data/assets/haedi.svg">`;
    ...
    readFile("./contributors.csv", "utf8", (error, text_content) => {
        ...
        var image_path = '../../docs/data/assets/drawings/standing_planet.jpg';
        //var icon_path = '../data/assets/sparkle_multi.svg';
        splitModal(header_text, paragraph_text, image_path, '');
    });
}

function splitModal(header_text, paragraph_text, image_path = '../../docs/data/assets/drawings/sitting_computer_sketch.jpg', icon_path = '../../data/assets/sparkle_multi.svg', width = "640px") {
    var modal = createModal(width);
...
function createModal(width = "640px") {
    // Create modal div
    ...
    modal_background.setAttribute("onclick", "hideModals()");
...
//                         <img src="../data/assets/sitting_computer_sketch.jpg">
//                     </figure>
//                 </div>
//                 <div class="column" style="border: none">
//                     <div class="content">
...
//                             <span class="icon is-medium ml-4"><img src="../data/assets/sparkle_multi.svg"></span>
//                         </span>
