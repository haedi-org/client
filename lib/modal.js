...
function exampleModal() {
    ...
    var image_path = '../data/assets/drawings/walking_tablet.jpg';
...
function aboutModal() {
    ...
    var header_text = `<img id="logo" class="pl-0 ml-0" src="../data/assets/haedi.svg">`;
    ...
    readFile("./contributors.csv", "utf8", (error, text_content) => {
        ...
        var image_path = '../data/assets/drawings/standing_hologram.jpg';
        //var icon_path = '../data/assets/sparkle_multi.svg';
        splitModal(header_text, paragraph_text, image_path, '');
    });
}

function splitModal(header_text, paragraph_text, image_path = '../data/assets/drawings/sitting_computer_sketch.jpg', icon_path = '../data/assets/sparkle_multi.svg', width = "640px") {
