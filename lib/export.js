...
//  modal_content_box.appendChild(modal_title);
    ...
    xml_icon_image.setAttribute('src', '../data/assets/icons/xml_file.svg');
    ...
    json_icon_image.setAttribute('src', '../data/assets/icons/json_file.svg');
    ...
    edi_icon_image.setAttribute('src', '../data/assets/icons/edi_file.svg');
    ...
    x12_icon_image.setAttribute('src', '../data/assets/icons/x12_file.svg');
    ...
    code_icon_image.setAttribute('src', '../data/assets/icons/code_file.svg');
