class PAC < Line
    def initialize(data, version, reference)
        ...
        @number_of_packages = var(1, 0)
        # (7075) Packaging level, coded
        @packaging_level = var(2, 0, "7075")
        # (7233) Packaging related information, coded
        @packaging_information = var(2, 1, "7233")
        # (7073) Packaging terms and conditions, coded
        @packaging_terms = var(2, 2, "7073")
        # (7065) Type of packages identification
        @type_of_packages_id = var(3, 0)
        # (1131) Code list qualifier
        @code_list = var(3, 1, "1131")
        # (3055) Code list responsible agency, coded
        @agency = var(3, 2, "3055")
        # (7064) Type of packages
        @type_of_packages = var(3, 3)
